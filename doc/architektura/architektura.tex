...
że podstawowe wywołania API rzucają wyjątkami wskazującymi na literówki w
kodzie. Od wersji 1.3 wzwyż, tylko jeden z takich bugów dotyczył naszego kodu.
Aby uruchomić projekt, należy usunąć 3 linie odpowiedzialne za logowanie w
kodzie swifta, ponieważ rzucają one wyjątkami. Ciekawe może być spostrzeżenie,
że na początku semestru zgłosiliśmy ten błąd developerom swifta, i do tej pory
